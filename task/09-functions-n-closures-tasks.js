...
function getPolynom() {
    return x => {
        ...
        return args.reduce((sum, val, i) => sum += val * Math.pow(x, i), 0);
    };    
}
...
function logger(func, logFunc) {       
    return function() { 
        const args = JSON.stringify(Array.prototype.slice.call(arguments)).slice(1, -1);                      
...
function partialUsingArguments(fn) {
    ...
    //return (...thisArgs) => fn.apply(this, args.concat(thisArgs));
    return function() { 
